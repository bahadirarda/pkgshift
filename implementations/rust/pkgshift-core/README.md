...
It owns repository inspection, Project IR, capability analysis, normalized lock graphs, native importer selection, immutable planning, integrity-checked state, transactional and isolated-trial execution, verification, and rollback. The Rust API is pre-1.0 and may evolve between minor releases.
